...
DECLARE_UNIQUE_INDEX(pg_model_info_name_version_index, 2030, on pg_model_info using btree(modelname name_ops, version int2_ops));
#define ModelInfoNameVersionIndex 2030
